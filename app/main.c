...
static uint8_t usart_input_stack[128];
THREAD i2c_master;
THREAD i2c_slave;
THREAD usart_input;
...
void setup()
{
	...
	BermudaThreadCreate(&usart_input, "USART", &USART_input, NULL, 128,
...
#endif
{
	...
	printf_P(PSTR("T=%u E=%X EM=%X\n"), temperature, read_back_eeprom, read_back_sram);
